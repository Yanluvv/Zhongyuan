  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          // Updated to a factory workshop environment (Industrial floor/Machinery)
          backgroundImage: 'url("https://www.infinair.com.cn/uploads/202403/26/3beca3bf248f9cfb.webp")',
        }}
      >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        <Reveal width="100%">
           <div className="mb-4 inline-block px-4 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/20">
             <span className="text-sm font-medium tracking-wider uppercase">Future of Energy</span>
           </div>
        </Reveal>
